...
public class RDRsegmenter {
    ...
    private void constructTreeFromRulesFile(String rulesFilePath) throws IOException {
    ...
    public void segmentTokenizedCorpus(String inFilePath) throws IOException {
        BufferedReader buffer = new BufferedReader(
    ...
    public void segmentRawCorpus(String inFilePath) throws IOException {
        BufferedReader buffer = new BufferedReader(
                new InputStreamReader(new FileInputStream(new File(inFilePath)), "UTF-8"));
        BufferedWriter bw = new BufferedWriter(
                new OutputStreamWriter(new FileOutputStream(inFilePath + ".WS"), "UTF-8"));
